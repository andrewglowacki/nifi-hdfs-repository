...
public class ContainerGroup implements Iterable<Container> {
    ...
    public ContainerGroup(NiFiProperties properties, RepositoryConfig repoConfig, Set<String> include,
        ...
        Map<String, Container> byName = new HashMap<>();
        for (Entry<String, String> entry : getContentRepositoryPaths(properties).entrySet()) {
    ...
    private Map<String, String> getContentRepositoryPaths(NiFiProperties properties) {
        Map<String, String> contentRepositoryPaths = new HashMap<>();
        ...
        for (String propertyName : properties.getPropertyKeys()) {
            ...
            if (StringUtils.startsWith(propertyName, REPOSITORY_CONTENT_PREFIX)) {
                ...
                contentRepositoryPaths.put(key, properties.getProperty(propertyName));
            }
        }
